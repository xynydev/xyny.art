...
{#each windows as window}
        ...
        >
            <div class="title-bar handle" role="toolbar" tabindex="0">
                ...
                <div class="title-bar-controls">
                    ...
                    <button
                        aria-label="Close"
                        onclick={() => (window.open = false)}
                    ></button>
                </div>
            </div>
            <div
                class="window-body prose prose-h1:text-4xl! prose-li:marker:text-black prose-ul:ps-4 prose-p:my-3 prose-img:my-2 prose-li:my-0 about text-sm"
            >
                {@render about()}
            </div>
        </div>
    ...
    {:else if window.type == "links"}
        ...
        >
            ...
            <div
                class="window-body font-ms p-4 gap-8 flex flex-row flex-wrap pb-8"
            >
                {#each links as link}
                    ...
                    >
                        ...
                        >
                            <img
                                ...
                                alt={p.data.gallery[0].images[0].alt}
                                class="max-w-full max-h-full w-fit h-fit mt-auto shadow-lg"
                            />
